	...
	return (
		<BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
			<div className="">
				...
				<HoverButton />
				<h2 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-zinc-300 dark:to-white text-4xl md:text-4xl lg:text-7xl font-unbounded py-2 md:py-10 relative z-20 font-bold tracking-tight my-3">
